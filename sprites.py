...
class Player(pygame.sprite.Sprite):
    ...
    def animate(self):
        down_animation = [self.game.character_spritesheet.get_sprite(3, 2, self.width, self.height),
                          self.game.character_spritesheet.get_sprite(35, 2, self.width, self.height),
                            self.game.character_spritesheet.get_sprite(68, 2, self.width, self.height)]
        
        up_animation = [self.game.character_spritesheet.get_sprite(3, 34, self.width, self.height),
                        self.game.character_spritesheet.get_sprite(35, 34, self.width, self.height),
                        self.game.character_spritesheet.get_sprite(68, 34, self.width, self.height)]
        
        left_animation = [self.game.character_spritesheet.get_sprite(3, 98, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(35, 98, self.width, self.height),
                           self.game.character_spritesheet.get_sprite(68, 98, self.width, self.height)]
        
        right_animation = [self.game.character_spritesheet.get_sprite(3, 66, self.width, self.height),
        ...
        if self.facing == 'left':
            if self.x_change == 0:
                ...
                self.animation_loop += 0.1
                if self.animation_loop >= len(left_animation):
                    self.animation_loop = 1
...
class Enemy(pygame.sprite.Sprite):
    ...
    def animate(self):
        left_animation = [self.game.enemy_spritesheet.get_sprite(3, 2, self.width, self.height),
        ...
        right_animation = [self.game.enemy_spritesheet.get_sprite(3, 66, self.width, self.height),
...
class Button:
    def __init__(self, x, y, width, height, fg, bg, content, fontsize):
        self.font = pygame.font.Font('arial.ttf.ttf', fontsize)
...
class Attack(pygame.sprite.Sprite):
    ...
    def animate(self):
        ...
        if direction == 'up':
            ...
            self.animation_loop += 0.5 # 공격 프레임 속도 조절절
